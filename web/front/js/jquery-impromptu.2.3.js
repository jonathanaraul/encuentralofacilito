...
jQuery.extend({	
	ImpromptuDefaults: { prefix:'jqi', buttons:{ Ok:true }, loaded:function(){}, submit:function(){return true;}, callback:function(){}, opacity:0.85, zIndex: 999, overlayspeed:'fast', promptspeed:'fast', show:'fadeIn', focus:0, useiframe:false, top:"15%", persistent: true },
	...
	prompt: function(m,o){
		...
		msgbox += '<div class="'+ o.prefix +'" id="'+ o.prefix +'"><div class="'+ o.prefix +'container"><div class="'+ o.prefix +'close"><img src="/images/close_ip.gif" /></div><div id="'+ o.prefix +'states"></div>';		
		msgbox += '</div></div></div>';
