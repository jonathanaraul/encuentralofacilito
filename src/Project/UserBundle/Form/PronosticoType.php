...
class PronosticoType extends AbstractType
{
        /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        -> add('fecha', 'text', array('label' => 'Fecha','required' => false))
        -> add('cuota', 'number', array('label' => 'Cuota','required' => false))
        -> add('skate', 'text', array('label' => 'Skate','required' => false))
        -> add('casaApuestas', 'text', array('label' => 'Casa de Apuestas','required' => false))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Project\UserBundle\Entity\Pronostico'
        ));
    }
