...
use Project\UserBundle\Entity\FuenteCategoria;

class ParserFuenteCategoriaController extends Controller {

const NOMBRE_CLASE = 'FuenteCategoria';
const NOMBRE_RUTA = 'fuente_categoria';
	...
	public function createAction(Request $request) {
		...
		$array['data'] = new FuenteCategoria();
