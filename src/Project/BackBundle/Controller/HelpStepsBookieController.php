...
use Project\UserBundle\Entity\HelpStepsBookie;

class HelpStepsBookieController extends Controller {

const NOMBRE_CLASE = 'HelpStepsBookie';
const NOMBRE_RUTA = 'help_steps_bookie';
	...
	public function listAction(Request $request) {
		...
		if ($this -> getRequest() -> isMethod('POST')) {
			...
			if ($form -> isValid()) {
				...
				$filtro->setDataTexto('titulo',$data -> getTitulo());
				$filtro->setDataBoolean('step',$data -> getStep());
				$filtro->setOrder();
				$filtro->setQuery();
				$filtro->setParametroTexto('titulo',$data -> getTitulo());
				$filtro->setParametroBoolean('step',$data -> getStep());
	...
	public function createAction(Request $request) {
		...
		$array['data'] = new HelpStepsBookie();
