...
use Project\UserBundle\Entity\TrackedWebs;

class TrackedWebsController extends Controller {

const NOMBRE_CLASE = 'TrackedWebs';
const NOMBRE_RUTA = 'tracked_webs';
